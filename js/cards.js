...
export function renderOffer(e){
    ...
    cardTemplateClone.querySelector('.popup__text--capacity').innerText = `${offerSettings.roomsTranslations[e.offer.rooms].en} ${offerSettings.guestsTranslations[e.offer.guests].en}`;
